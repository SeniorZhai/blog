...
public class Config {
	...
	public static final String PREER_NAME = "dictionary_profer";
	...
	public void setPreference(String key,Object value) {
		SharedPreferences shardPreferences = context.getSharedPreferences(PREER_NAME,Context.MODE_PRIVATE);
