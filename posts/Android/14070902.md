  ...
  private final String TAG = getClass().getSimpleName();
    ...
    private void getThumbnail() {
        String[] projection = { Thumbnails._ID, Thumbnails.IMAGE_ID,
				Thumbnails.DATA };
	    Cursor cursor = cr.query(Thumbnails.EXTERNAL_CONTENT_URL,projection,null,null,null);
    ...
    private void getThumbnailColumnData(Cursor cur) {
        if (cur.moveToFirst()) {
            ...
            int image_idColumn = cur.getColumnInde(Thumbnails.IMAGE_ID);
            int dataColumn = cur.getColumnIndex(Thumbnail.DATA);
            do{
    ...
    private void getAlumColumnData(Cursor cur) {
        if (cur.moveToFirst()){
            int _id;
            String album;
            String albumArt;
            ...
            do{
                ...
                hash.put("numOfSonges",numOfSongs+"");
                albumList.add(add);
            }while(cur.moveToNext());
        }
    }
    ...
    private void buildImagesBucketList(){
        ...
        getThumbnail();
        String columns[] = new String[] { Media._ID,Media.BUCKET_ID,Media.PICASA_ID,Medie.DATA,Media.DISPLAY_NAME,Medie.Title,Media.SIZE,Medie.BUCKET_DISPLAY_NAME};
